...
var (
	...
	// PN14Q438 is a set of default parameters with logN=14 and logQ=438
	PN14Q438 = ParametersLiteral{
		LogN: 14,
	...
	// PN15Q880 is a set of default parameters with logN=15 and logQ=880
	PN15Q880 = ParametersLiteral{
		LogN: 15,
		Q: []uint64{0xffffffffffc0001, 0x10000000001d0001, 0x10000000006e0001, // 60 + 60 + 60 bits
...
// DefaultParamsJ is a set of default BFV parameters ensuring 128 bit security in the classic setting by jzhchu.
var DefaultParamsJ = []ParametersLiteral{PN11QP54, PN12Q109, PN13Q218, PN14Q438, PN15Q880}
